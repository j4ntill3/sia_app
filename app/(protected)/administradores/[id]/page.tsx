...
export default function EditarAdministrador({ params }: { params: Promise<{ id: string }> }) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (selectedImage && personaId) {
          ...
          if (imgRes.ok) {
            alert("Administrador actualizado con imagen.");
          } else {
            alert("Administrador actualizado, pero la imagen no se pudo guardar.");
          }
        } else {
    ...
    <div className="min-h-[calc(100vh-80px-56px)] bg-gray-100 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Editar Administrador</h1>
            <p className="text-gray-600 mt-2">Modifica los datos del administrador en el sistema</p>
          </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <form id="administrador-form" onSubmit={handleSubmit}>
