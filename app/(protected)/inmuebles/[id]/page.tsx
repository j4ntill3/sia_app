...
const InmuebleDetail = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className=" flex items-center justify-center bg-gray-100 p-4">
      ...
      {/* Modal de edición */}
      {editMode && (
        <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-10 text-[#083C2C]">
          <div className="bg-white p-6 rounded-lg w-1/3">
            ...
            <div className="flex justify-end space-x-2">
              <button
                ...
                className="bg-gray-300 text-gray-700 px-4 py-2 rounded-full hover:underline"
              >
                Cancelar
              </button>
              ...
              <button
                onClick={handleSave}
                className="px-4 py-2 bg-[#6FC6D1] text-white rounded-full hover:underline"
              >
                Guardar
              </button>
            </div>
      ...
      {isAgentModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-600 bg-opacity-50 text-[#083C2C]">
